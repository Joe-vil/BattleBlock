			...
			case 'bbt-stage':
				{
						...
						var bottomfloor:BGSprite = new BGSprite('bbt/catfloor', -665.9, 2068.85);
						bottomfloor.updateHitbox();
						bottomfloor.antialiasing = true;
						bottomfloor.active = false;
	
						var rail:BGSprite = new BGSprite('bbt/fence', 362.95, 1540.9);
						rail.updateHitbox();
						rail.antialiasing = true;
						rail.active = false;

						var upperstage:BGSprite = new BGSprite('bbt/stage', -438.3, 1724.15);
						upperstage.updateHitbox();
						upperstage.antialiasing = true;
						upperstage.active = false;

						var rafter:BGSprite = new BGSprite('bbt/rafter', 282.95, 824.6);
						rafter.updateHitbox();
